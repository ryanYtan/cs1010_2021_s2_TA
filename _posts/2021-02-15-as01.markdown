...
The goal of this question is to find the surface area and "diagonal"
of a box (cuboid), as depicted in the image above.
...
We can express the above recursive formulation using a math expression
